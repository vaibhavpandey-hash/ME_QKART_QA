...
public class QKART_Tests {
    ...
    public void TestCase02() throws InterruptedException {
        ...
        Assert.assertFalse(status,"Failed testcase02");
    ...
    public void TestCase03() throws InterruptedException {
        ...
        softObj.assertTrue(status,"Unable to search a product");
        // if (!status) {
        ...
        softObj.assertTrue(status,"Search returned empty list");
        for (WebElement webElement : searchResults) {
            ...
            softObj.assertTrue(status,"Incorrect product shown");
        }
        ...
        softObj.assertTrue(status,"Results available for invalid search");
        softObj.assertAll("Testcase03 failed");
    ...
    public void TestCase04() throws InterruptedException {
        ...
        for (WebElement webElement : searchResults) {
            ...
            Assert.assertTrue(result.verifySizeChartExists(),"Verification of size chart is failed");
            Assert.assertTrue(result.verifyExistenceofSizeDropdown(driver),"Verification of dropdown is failed");
        ...
        //                 status = false;
        //             }
        status=result.openSizechart() && result.validateSizeChartContents(expectedTableHeaders, expectedTableBody, driver);
        Assert.assertTrue(status,"Verification of size chart and its content is failed");
    ...
    public void TestCase05(String product1,String product2,String address) throws InterruptedException {
        ...
        Assert.assertTrue(status,"Unable to search for Yonex");
        homePage.addProductToCart(product1);
        status = homePage.searchForProduct(product2);
        Assert.assertTrue(status,"Unable to search for tan");
        ...
        Assert.assertTrue(status,"Didnot navigated to thanks page");
    ...
    public void TestCase07(String product,String qty) throws InterruptedException {
        Boolean status;
        ...
        //     return false;
        // }
        Assert.assertTrue(status, "Failed to rigister a new user");
        lastGeneratedUserName = registration.lastGeneratedUsername;
        ...
        Assert.assertTrue(status, "Failed to search a product");
        ...
        Assert.assertTrue(status, "Failed to verify the message");
    ...
    public void TestCase08() throws InterruptedException {
        ...
        Assert.assertTrue(status, "Unable to verify the content of the cart");    
        driver.close();
    ...
    public void TestCase09() throws InterruptedException {
        ...
        Assert.assertTrue(status, "Basepage url is changed");    
        // if (!status) {
        ...
        softObj.assertTrue(status,"Text is not equal to Privacy Policy");
        // if (!status) {
        ...
        softObj.assertTrue(status,"Text is not equal to Terms of Service");
        // if (!status) {
    ...
    public void TestCase11() throws InterruptedException {
        ...
        Assert.assertTrue(status, "Failed to search for product");
        homePage.addProductToCart("YONEX Smash Badminton Racquet");
        ...
        SoftAssert softObj=new SoftAssert();
        softObj.assertTrue(status, "Failed to verify that 3 Advertisements");
        ...
        softObj.assertTrue(status, "Failed to verify Advertisement 1 is clickable");
        ...
        status = !driver.getCurrentUrl().equals(currentURL);
        softObj.assertTrue(status, "Failed to verify Advertisement 2 is clickable");
