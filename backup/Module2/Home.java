...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            WebElement searchBox = driver.findElement(By.className("MuiInputBase-input"));
            searchBox.clear();
    ...
    public Boolean verifyCartContents(List<String> expectedCartContents) {
        try {
            WebElement cartParent = driver.findElement(By.className("cart"));
            List<WebElement> cartContents = cartParent.findElements(By.className("cart-item"));

            ArrayList<String> actualCartContents = new ArrayList<>();
            for (WebElement cartItem : cartContents) {
                actualCartContents.add(cartItem.findElement(By.className("product-name")).getText());
            }
